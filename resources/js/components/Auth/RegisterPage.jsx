            ...
            <Grid container spacing={2} sx={{ position: 'relative', zIndex: 1 }}>
                <Grid item xs={12} md={6} order={1}>
                    <Box display="flex" justifyContent="center" alignItems="center" height="100%" position="relative">
                        ...
                        <img src="/image/register.webp" alt="register"
                            style={{
                                maxWidth: "100%",
                                position: 'relative',
                                zIndex: 1
                ...
                <Grid item xs={12} md={6} order={2}>
                    <Card elevation={20} className="login-card-animation" sx={{
                        maxWidth: "400px",
                        borderRadius: 3,
                        width: "100%",
                        height: "fit-content",
                        ...
                        <CardContent sx={{ py: 0.6 }}>
                            ...
                            <form onSubmit={handleRegister}>
                                ...
                                />
                                <Button type="submit" variant="contained" color="primary" fullWidth size="large" style={{ marginTop: "0.5rem" }} disabled={isLoading}>
