...
const AddShopPage = () => {
    ...
    const handleIconClick = () => {
        // Show SweetAlert asking if they want to use the current location
        showAlert({
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${apiUrl}/admin/shop/create_shop`, formData, {
            headers: {
            ...
            .then(response => {
                ...
                showSnackbar(shopData.message, { severity: 'success' });
                setTimeout(() => {
                    setLoading(false);
                    navigate("/shop");
                }, 2000);
                ...
                if (error.response) {
                    if (error.response.data && error.response.data.errors) {
                        ...
                        if (error.response.data.errors.shop_type_name) {
                            setNameError(error.response.data.errors.shop_type_name[0]);
                        }
    ...
    useEffect(() => {
        const fetchShopTypes = async () => {
            try {
                ...
                showSnackbar('Error fetching shops:', error, { severity: 'error' }, 2000);
                setLoading(false);
            }
        };
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            >
                ...
                {!loading && (
                    <Grid>
                        <PageHeader title="Add Shop" handleBackClick={handleBackClick} />
