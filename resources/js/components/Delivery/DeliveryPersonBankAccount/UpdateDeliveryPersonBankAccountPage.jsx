...
const UpdateDeliveryPersonBankAccountPage = () => {
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${apiUrl}/admin/delivery_person_bank_account/update_account`, formData, {
            headers: {
        ...
        const fetchAccount = async () => {
            try {
                ...
                const response = await axios.put(
                    `${apiUrl}/admin/delivery_person_bank_account/find_account`,
                ...
                setDeliveryPersonId(accountData.delivery_person_id);
    ...
    useEffect(() => {
        const fetchDeliveryPersons = async () => {
            try {
                ...
                showAlert({
                    title: "Error!",
                    text: "Error fetching delivery persons:", error,
                    icon: "error",
                });
            }
        };
...
export default UpdateDeliveryPersonBankAccountPage;
