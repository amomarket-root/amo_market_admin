...
const AddDeliveryPersonPage = () => {
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${apiUrl}/admin/delivery_person/create_delivery_person`, formData, {
            headers: {
            ...
            .then(response => {
                const deliveryPersonData = response.data;
                showSnackbar(deliveryPersonData.message, { severity: 'success' });
                setTimeout(() => {
                    setLoading(false);
    ...
    useEffect(() => {
        return () => {
            if (panPhoto.startsWith('blob:')) {
                URL.revokeObjectURL(panPhoto); // Clean up URL.createObjectURL()
            }
        };
    }, [panPhoto]);
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            >
                ...
                {!loading && (
                    <Grid>
                        <PageHeader title="Add Delivery Person" handleBackClick={handleBackClick} />
                        ...
                        <ActionButtons
                            ...
                            loading={loading}
                            submitLabel="Add Delivery Person"
                        />
                    </Grid>
                )}
            </Paper>
