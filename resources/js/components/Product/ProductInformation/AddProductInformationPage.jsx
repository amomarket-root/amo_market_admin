...
const AddProductInformationPage = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                setProducts(response.data.data || []); // Ensure `data` is an array
                setLoading(false);
            } catch (error) {
                showAlert({
                    title: "Error!",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${apiUrl}/admin/product_info/create_product_info`, formData, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`,
            ...
            showSnackbar('Product Information added successfully!', { severity: 'success' });
            setTimeout(() => {
                setLoading(false);
                navigate("/product-information");
            }, 2000);
            ...
            showAlert({
                title: "Error!",
                text: "Error adding product information. Please try again.",
                icon: "error",
            });
        }
    };
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            >
                ...
                {!loading && (
                    <Grid>
                        <PageHeader title="Add Product Information" handleBackClick={handleBackClick} />
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit}>
                                <Box sx={{ mb: 4 }}>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            <Autocomplete
                                                options={products || []} // Fallback to an empty array if `products` is undefined
                                                getOptionLabel={(option) => option.name || ''}
                                                value={products?.find(product => product.id === productInfo.product_id) || null} // Optional chaining to prevent errors
                                    ...
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            ...
                                            {productInfo.second_unit_image && (
                                                <Box sx={{ mt: 2 }}>
                                                    <img
                                                        src={URL.createObjectURL(productInfo.second_unit_image)}
                                                        alt="Second Unit"
                                    ...
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            ...
                                            {productInfo.third_unit_image && (
                                                <Box sx={{ mt: 2 }}>
                                                    <img
                                                        src={URL.createObjectURL(productInfo.third_unit_image)}
                                                        alt="Third Unit"
                                                        style={{ width: '100px', height: '100px' }}
                                                    />
                                                </Box>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            ...
                                            {productInfo.product_image_one && (
                                                <Box sx={{ mt: 2 }}>
                                                    <img
                                                        src={URL.createObjectURL(productInfo.product_image_one)}
                                                        alt="Product One"
                                                        style={{ width: '100px', height: '100px' }}
                                                    />
                                                </Box>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            ...
                                            {productInfo.product_image_two && (
                                                <Box sx={{ mt: 2 }}>
                                                    <img
                                                        src={URL.createObjectURL(productInfo.product_image_two)}
                                                        alt="Product Two"
                                                        style={{ width: '100px', height: '100px' }}
                                                    />
                                                </Box>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            ...
                                            {productInfo.product_image_three && (
                                                <Box sx={{ mt: 2 }}>
                                                    <img
                                                        src={URL.createObjectURL(productInfo.product_image_three)}
                                                        alt="Product Three"
                                                        style={{ width: '100px', height: '100px' }}
                                                    />
                                                </Box>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            ...
                                            {productInfo.product_image_four && (
                                                <Box sx={{ mt: 2 }}>
                                                    <img
                                                        src={URL.createObjectURL(productInfo.product_image_four)}
                                                        alt="Product Four"
                                                        style={{ width: '100px', height: '100px' }}
                                                    />
                                                </Box>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            ...
                                            {productInfo.product_image_five && (
                                                <Box sx={{ mt: 2 }}>
                                                    <img
                                                        src={URL.createObjectURL(productInfo.product_image_five)}
                                                        alt="Product Five"
                                                        style={{ width: '100px', height: '100px' }}
                                                    />
                                                </Box>
                                        ...
                                        <Grid item xs={6} sx={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            {productInfo.product_extra_image && (
                                                <Box sx={{ mt: 2, display: 'flex', alignItems: 'center', ml: 2 }}>
                                                    <img
                                                        src={URL.createObjectURL(productInfo.product_extra_image)}
                                                        alt="Product Extra"
                                                        style={{ width: '100px', height: '100px' }}
                                                    />
                                                </Box>
                                ...
                                <Divider sx={{ marginY: 1 }} />
                                {/* Final Buttons for Submission and Cancellation */}
                                <ActionButtons
                                    handleCancel={handleCancelClick}
                                    handleSubmit={handleSubmit}
                                    loading={loading}
                                    submitLabel="Add Product Information"
                                />
                            </form>
                        </CardContent>
                    </Grid>
...
export default AddProductInformationPage;
