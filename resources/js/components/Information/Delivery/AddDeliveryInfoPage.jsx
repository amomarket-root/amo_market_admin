...
const AddDeliveryInfoPage = () => {
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${apiUrl}/admin/delivery_pages/create_delivery_page`, formData, {
            headers: {
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            >
                ...
                {!loading && (
                    <Grid>
                        <PageHeader title="Add Delivery Page" handleBackClick={handleBackClick} />
...
export default AddDeliveryInfoPage;
