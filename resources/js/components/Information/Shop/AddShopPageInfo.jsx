...
const AddShopPageInfo = () => {
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${apiUrl}/admin/shop_pages/create_shop_page`, formData, {
            headers: {
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            >
                ...
                {!loading && (
                    <Grid>
                        <PageHeader title="Add Shop Page" handleBackClick={handleBackClick} />
...
export default AddShopPageInfo;
