...
const UpdateTermPage = () => {
    ...
    const handleUpdate = () => {
        ...
        axios.post(`${apiUrl}/admin/terms/update_term`, formData, {
            headers: {
    ...
    useEffect(() => {
        ...
        const token = localStorage.getItem('token');
        axios.put(
            `${apiUrl}/admin/terms/find_term`,
            qs.stringify({ id: termId }),
            {
                headers: {
                    Authorization: `Bearer ${token}`,
            ...
            .then((response) => {
                ...
                setImagePath(termData.image_path || "/image/no_image.webp");
                setLoading(false);
            })
            .catch((error) => {
                showAlert({
                    title: "Error!",
                    text: "Error fetching term data: " + error.message,
                    icon: "error",
                });
                setLoading(false);
            });
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            >
                ...
                {!loading && (
                    <Grid>
                        <PageHeader title="Update Term & Condition" handleBackClick={handleBackClick} />
