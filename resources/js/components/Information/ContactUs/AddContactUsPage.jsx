...
const AddContactUsPage = () => {
    ...
    const handleSubmit = () => {
        ...
        const dataToSend = {
            ...formData,
            social_media: formData.social_media // Already an object, don't stringify here
        };

        axios.post(`${apiUrl}/admin/contact_us/create_contact_us`, dataToSend, {
            headers: {
        ...
        .catch(error => {
            ...
            if (error.response?.data?.errors) {
                ...
                showAlert({
                    title: "Error!",
                    text: errorMessage || "Server error or network issue. Please try again later.",
                    icon: "error",
                });
            }
        });
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            >
                ...
                {!loading && (
                    <Grid>
                        <PageHeader title="Add Contact Us" handleBackClick={handleBackClick} />
