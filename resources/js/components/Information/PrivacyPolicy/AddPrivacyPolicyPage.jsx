...
const AddPrivacyPolicyPage = () => {
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${apiUrl}/admin/privacy_policy/create_privacy_policy`, formData, {
            headers: {
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            >
                ...
                {!loading && (
                    <Grid>
                        <PageHeader title="Add Privacy Policy" handleBackClick={handleBackClick} />
                        ...
                        <ActionButtons
                            ...
                            loading={loading}
                            submitLabel="Add Privacy Policy"
                        />
                    </Grid>
                )}
            </Paper>
