...
const AddAvatarPage = () => {
    ...
    const handleSubmit = () => {
        ...
        if (!avatarImageFile) {
            setAvatarImageError('Please upload an avatar image');
            setLoading(false);
            return;
        }
        ...
        axios.post(`${apiUrl}/admin/avatar/create_avatar`, formData, {
            headers: {
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            >
                ...
                {!loading && (
                    <Grid>
                        <PageHeader title="Add Avatar" handleBackClick={handleBackClick} />
